...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionRestoreDefaults = QAction(MainWindow)
        self.actionRestoreDefaults.setObjectName(u"actionRestoreDefaults")
        ...
        self.menuMenu.addAction(self.actionRestoreDefaults)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionRestoreDefaults.setText(QCoreApplication.translate("MainWindow", u"Restore defaults", None))
        ...
        self.sigmaSlider.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>This is the sigma value to be used in the gaussian filter. The greater the sigma, the sharper the resulting image. The recommened default value for herring is 2.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.sigmaSlider.setWhatsThis(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>this is something!!</p></body></html>", None))
...
#if QT_CONFIG(tooltip)
        self.amountSlider.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>This variable is simply a multiplier for the details captured by the unsharp mask. The greater this value, the more pronounced the captured details will be. The recommended default value for herring otolith images is 17.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.colorMap.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>An optional application of a color map to the enhanced images.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
